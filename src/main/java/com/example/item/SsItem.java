...
public class SsItem extends Item {
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		RandomizableContainerBlockEntity.setLootTable(context.getLevel(), random, new BlockPos( context.getClickedPos().getX(), context.getClickedPos().getY()+1, context.getClickedPos().getZ()),new ResourceLocation("examplemod:chests/bonusplus"));
